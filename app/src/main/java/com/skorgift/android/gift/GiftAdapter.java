package com.skorgift.android.gift;
...
public class GiftAdapter extends BaseAdapter {
	...
	private List<GiftData> mData = new ArrayList<GiftData>();
	...
	public void add(GiftData item) {
		mData.add(item);
	}

	public void addAll(List<GiftData> data) {
		mData.addAll(data);
	}
	...
	@Override
	public GiftData getItem(int position) {
			...
			convertView.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					if (mItemClickedListener != null) {
						...
						GiftData item = getItem(itemPosition);
	...
	public interface OnItemClickedListener {
		void onItemClicked(GiftData item, int position);
	}
